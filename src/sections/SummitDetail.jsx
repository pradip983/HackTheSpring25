            ...
            <div className="max-w-6xl mx-auto p-6 text-blue-900">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                    <div className="space-y-6">
                        <InfoCard title="Summit Name" value={franchise.franchiseName} />
                        <InfoCard title="Description" value={franchise.description} />
                        <InfoCard title="Registration Link" value={`www.${franchise.franchiseName}.com`} />
                       
                    </div>
                    <div className="space-y-6">
                        <InfoCard title="Location Available" value={franchise.location} />
                        <InfoCard title="Coupon Code" value={franchise.category} />
